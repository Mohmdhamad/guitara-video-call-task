...
//   ContactsCubit() : super(ContactsLoaded(
...
//     return [
//       UserModel(id: 'fav1', name: 'Ahmed Ali', isOnline: true),
//       UserModel(id: 'fav2', name: 'Sara Mohamed', isOnline: false),
//       UserModel(id: 'fav3', name: 'Omar Hassan', isOnline: true),
//       UserModel(id: 'fav4', name: 'Nour Ibrahim', isOnline: false),
//       UserModel(id: 'fav5', name: 'Youssef Adel', isOnline: true),
//     ];
//   }
//
...
//       UserModel(id: 'rec4', name: 'Juanita S. Wagner'),
